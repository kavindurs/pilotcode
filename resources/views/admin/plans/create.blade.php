...
@section('page-subtitle', 'Add a new subscription plan with pricing and features.')
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-600 mx-2"></i>
                    <span class="text-gray-300">Create New Plan</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-xl shadow-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-4 border-b border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold text-white">Create New Plan</h2>
                    <p class="text-gray-400 text-sm">Define pricing and features for a new subscription plan</p>
                </div>
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('admin.plans.store') }}" class="p-6">
            @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('html_integration_limit', 0) }}"
                                    required
                                    min="0"
                                    placeholder="5"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('review_invitation_limit', 0) }}"
                                    required
                                    min="0"
                                    placeholder="1000"

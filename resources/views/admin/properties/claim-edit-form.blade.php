    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            @if($canEditStatus)
                ...
                @if(isset($isClaim) && $isClaim)
                    ...
                    <input type="text" value="Approved" readonly
                           class="mt-1 block w-full rounded-md border-gray-600 bg-gray-600 text-gray-400 shadow-sm cursor-not-allowed">
                    <p class="mt-1 text-sm text-red-400">Status is automatically set to "Approved" when claiming a property.</p>
                @else
                    <select name="status" id="status" class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-200 shadow-sm focus:border-orange-500 focus:ring-orange-500" required>
            ...
            @else
                ...
                <div class="mt-1 block w-full rounded-md border-gray-600 bg-gray-600 text-gray-400 shadow-sm cursor-not-allowed p-3">
                    {{ $property->status }}

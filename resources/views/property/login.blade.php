    ...
    <div class="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center"
        ...
        <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
            ...
            <div class="text-center">
                ...
                <h2 class="mt-6 text-3xl font-bold text-blue-900">Sign in to Your Property Account</h2>
            ...
            <!-- Login Form -->
            <form method="POST" action="{{ route('property.login.submit') }}" class="mt-8 space-y-6">
                @csrf
                <div>
                    ...
                    <input id="business_email" name="business_email" type="email" required
                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-600 focus:border-blue-600"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('property.password.request') }}" class="font-medium text-blue-600 hover:text-blue-900">
                ...
                <div>
                    <button type="submit"
                            class="w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 transition-colors">
                        Sign in
                    </button>
                </div>
            </form>

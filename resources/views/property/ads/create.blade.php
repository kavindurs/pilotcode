...
@section('page-subtitle', 'Create a new advertising campaign to promote your business.')
...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-600 mx-2"></i>
                    <span class="text-gray-300">Create New Ad</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <form action="{{ route('property.ads.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="ad_type"
                        ...
                        <option value="banner" {{ old('ad_type') === 'banner' ? 'selected' : '' }}>Banner Ad</option>
                        <option value="featured" {{ old('ad_type') === 'featured' ? 'selected' : '' }}>Featured Listing</option>
                        <option value="promoted" {{ old('ad_type') === 'promoted' ? 'selected' : '' }}>Promoted Content</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="placement"
                        ...
                        <option value="homepage" {{ old('placement') === 'homepage' ? 'selected' : '' }}>Homepage</option>
                        <option value="category" {{ old('placement') === 'category' ? 'selected' : '' }}>Category Pages</option>
                        <option value="search_results" {{ old('placement') === 'search_results' ? 'selected' : '' }}>Search Results</option>
                        <option value="property_details" {{ old('placement') === 'property_details' ? 'selected' : '' }}>Property Details</option>
                    </select>
                </div>
        ...
        <div class="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
            ...
            <div class="mt-4 p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div class="text-sm">
                        <p class="text-blue-300 font-medium">Campaign Review Process</p>
                        <p class="text-blue-200/80 mt-1">
                            Your ad will be submitted for review and approval by our admin team before going live.
                            This typically takes 24-48 hours. You'll be notified once your ad is approved and active.
                        </p>
                    </div>
                </div>
            </div>

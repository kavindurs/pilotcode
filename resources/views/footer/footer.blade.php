    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="https://cimacleaners.com.au/wp-content/uploads/2025/05/10-scaled.png" alt="" />

                <p class="text-base leading-relaxed text-gray-600 mt-7">Scoreness is a trusted rating and review platform where users evaluate and compare both physical businesses and online services.</p>
            ...
            <div>
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Secoreness</p>

                <ul class="mt-6 space-y-4">
                    <li>
                        <a href="{{ route('categories.index') }}" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Categories </a>
                    </li>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    <li>
                        <a href="{{ route('contact.us') }}" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Contact Us </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('terms.conditions') }}" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Terms & Conditions </a>
                    </li>

                    <li>
                        <a href="{{ route('privacy.policy') }}" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Privacy Policy </a>
                    </li>
                </ul>
            </div>
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Scoreness - Developed By Code Burg Technologies</p>
    </div>
</section>

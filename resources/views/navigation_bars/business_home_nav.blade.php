    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="flex-shrink-0">
                <a href="/business" class="flex items-center space-x-2">
            ...
            <div class="hidden lg:flex lg:items-center lg:ml-auto lg:space-x-6">
                ...
                <a href="{{ route('property.create.step1') }}" class="inline-flex items-center px-6 py-3 text-base font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors">
        ...
        <div x-show="isMenuOpen" class="lg:hidden">
            <nav class="pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md">
                ...
                <div class="px-6 mt-6">
                    <a href="{{ route('property.create.step1') }}" class="inline-flex justify-center w-full px-4 py-3 text-base font-semibold text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700">
                        List Property
                    </a>
                </div>
            </nav>

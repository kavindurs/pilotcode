<section class="py-12 bg-white sm:py-16 lg:py-20">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Why Choose Scoreness</h2>
            <p class="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">Everything you need to make informed decisions about businesses and services</p>
        </div>
        ...
        <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            <div class="md:p-8 lg:p-14">
                ...
                <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">24/7 Support</h3>
                <p class="mt-5 text-base text-gray-600 font-pj">Our dedicated customer service team is available around the clock to assist with any questions about reviews or business listings.</p>
            </div>
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">Data Analytics</h3>
                <p class="mt-5 text-base text-gray-600 font-pj">Comprehensive metrics and insights help you understand review trends, customer sentiment, and business performance over time.</p>
            </div>
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">Business Profiles</h3>
                <p class="mt-5 text-base text-gray-600 font-pj">Customizable business listings with detailed information, photos, opening hours, and direct contact options for potential customers.</p>
            </div>
            ...
            <div class="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                ...
                <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">Review Management</h3>
                <p class="mt-5 text-base text-gray-600 font-pj">Powerful tools for businesses to respond to reviews, track feedback, and implement changes based on customer suggestions.</p>
            </div>
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">Verified Reviews</h3>
                <p class="mt-5 text-base text-gray-600 font-pj">Our rigorous verification process ensures all reviews are authentic, giving consumers confidence and businesses fair representation.</p>
            </div>
            ...
            <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">Smart Recommendations</h3>
                <p class="mt-5 text-base text-gray-600 font-pj">Personalized business recommendations based on your preferences, past reviews, and location to help you discover services you'll love.</p>
            </div>
        </div>
    </div>
</section>

        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg shadow-sm overflow-hidden mb-8">
            <div class="p-8 sm:p-10 text-center">
                ...
                <p class="text-blue-100 mb-6 max-w-2xl mx-auto">
                    Your review helps businesses improve and helps others make informed decisions.
                </p>
                <a href="#search-input" class="inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-md shadow-sm text-blue-700 bg-white hover:bg-blue-50">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                ...
                                or
                                <a href="{{ route('register') }}" class="font-medium underline text-yellow-700 hover:text-yellow-600">
                                    create an account
                                </a>
                            </p>
                        </div>
                ...
                <form id="addPropertyForm" action="{{ route('properties.store') }}" method="POST" class="space-y-6">
                    ...
                    <div id="step1" class="transition-opacity duration-300">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                <input type="radio" id="physical" name="property_type" value="Physical" class="peer hidden" required>
                                <label for="physical" class="flex flex-col items-center p-5 text-gray-700 bg-white rounded-lg border border-gray-300 cursor-pointer peer-checked:border-blue-600 peer-checked:bg-blue-50 hover:bg-gray-50">
                                    <i class="fas fa-store text-3xl mb-3 text-blue-600"></i>
                                    <span class="font-medium">Physical Business</span>
                                    <span class="text-xs text-gray-500 mt-1">Brick and mortar location with a physical address</span>
                                </label>
                                <div class="absolute hidden w-5 h-5 peer-checked:flex justify-center items-center top-3 right-3 text-blue-600">
                                    <i class="fas fa-check-circle"></i>
                                </div>
                            </div>

                            <div class="relative">
                                <input type="radio" id="web" name="property_type" value="Web" class="peer hidden">
                                <label for="web" class="flex flex-col items-center p-5 text-gray-700 bg-white rounded-lg border border-gray-300 cursor-pointer peer-checked:border-blue-600 peer-checked:bg-blue-50 hover:bg-gray-50">
                                    <i class="fas fa-globe text-3xl mb-3 text-blue-600"></i>
                                    <span class="font-medium">Web Business</span>
                                    <span class="text-xs text-gray-500 mt-1">Online business, e-commerce or digital service</span>
                                </label>
                                <div class="absolute hidden w-5 h-5 peer-checked:flex justify-center items-center top-3 right-3 text-blue-600">
                                    <i class="fas fa-check-circle"></i>
                                </div>
                        ...
                        <div class="flex justify-end mt-6">
                            <button type="button" id="step1Next" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-blue-300" disabled>Continue</button>
                        </div>
                    </div>
                    ...
                    <div id="step2" class="hidden transition-opacity duration-300">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div id="domain_field" class="hidden">
                                <label for="domain" class="block text-sm font-medium text-gray-700 mb-1">Website Domain *</label>
                            ...
                            <div id="other_country_field" class="hidden">
                                <label for="other_country" class="block text-sm font-medium text-gray-700 mb-1">Specify Country *</label>
                        ...
                        <div class="flex justify-between mt-6">
                            ...
                            <button type="button" id="step2Next" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-blue-300" disabled>Continue</button>
                        </div>
                    </div>
                    ...
                    <div id="step3" class="hidden transition-opacity duration-300">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <select id="category-select" name="category_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div id="existing-category-container">
                            <div class="mb-6">
                                <label for="existing_category" class="block text-sm font-medium text-gray-700 mb-1">Select Category *</label>
                            ...
                            <div class="mb-6">
                                <label for="subcategory_type" class="block text-sm font-medium text-gray-700 mb-1">Subcategory</label>
                                <select id="subcategory-select" name="subcategory_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    <option value="existing">Select from existing subcategories</option>
                                    <option value="new">Add new subcategory</option>
                                </select>
                            </div>

                            <div id="existing-subcategory-container" class="mb-6">
                                <label for="existing_subcategory" class="block text-sm font-medium text-gray-700 mb-1">Select Subcategory</label>
                                <select id="existing_subcategory" name="existing_subcategory" disabled class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    <option value="">First select a category</option>
                                </select>
                            </div>

                            <div id="new-subcategory-container" class="mb-6 hidden">
                                <label for="new_subcategory" class="block text-sm font-medium text-gray-700 mb-1">New Subcategory Name</label>
                        ...
                        <div id="new-category-container" class="hidden">
                            ...
                            <div class="mb-6">
                                <label for="new_category_subcategory" class="block text-sm font-medium text-gray-700 mb-1">Subcategory for New Category</label>
                                <input type="text" id="new_category_subcategory" name="new_category_subcategory" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="Enter subcategory name (optional)">
                            </div>
                        </div>
                    ...
                    <!-- Step 4: Subcategory Selection (Newly Added) -->
                    <div id="step4" class="hidden transition-opacity duration-300">
                        ...
                        <div id="subcategory-content">
                            <!-- Subcategory content will be populated by JavaScript -->
                        </div>
                ...
                <div id="formSuccess" class="hidden">
                    <div class="rounded-md bg-green-50 p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-green-800">Business Added Successfully</h3>
                                <div class="mt-2 text-sm text-green-700">
                                    <p>Your business has been added successfully. It will be reviewed by our team shortly.</p>
                                </div>
                                <div class="mt-4">
                                    <div class="-mx-2 -my-1.5 flex">
                                        <a href="/property/" id="viewBusinessLink" class="rounded-md bg-green-100 px-2 py-1.5 text-sm font-medium text-green-800 hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-green-50">
                                            View Business
                                        </a>
                                    </div>
                                </div>

...
// Clear any existing payment records for property 1
echo "Step 1: Cleaning up existing payment records...\n";
$existingPayments = \App\Models\Payment::where('property_id', 1)->get();
foreach ($existingPayments as $payment) {
    echo "Deleting existing payment ID: {$payment->id}\n";
    $payment->delete();
}
...
// Check that no payment records exist
$paymentCount = \App\Models\Payment::where('property_id', 1)->count();
echo "Payment records for property 1: $paymentCount\n\n";
...
echo "✓ Property 1 found: {$property->business_name}\n";
...
$paymentCountAfterProcess = \App\Models\Payment::where('property_id', 1)->count();
echo "Payment records for property 1: $paymentCountAfterProcess\n";
...
$finalPaymentCount = \App\Models\Payment::where('property_id', 1)->count();
$finalPayment = \App\Models\Payment::where('property_id', 1)->first();
